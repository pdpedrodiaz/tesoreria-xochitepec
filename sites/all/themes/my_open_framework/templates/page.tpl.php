...
<?php if (($main_menu) || ($page['search_box']) &&($user->uid)): ?>
...
<?php if (($page['header_bottom']) || ($title)): ?>
...
<?php if ($page['footer_top']): ?>
  <div id="footer-top" class="row-fluid footer-top"> <div class="container"><?php print render($page['footer_top']); ?></div> </div>
<?php endif; ?>

<?php if ($page['footer_upper']): ?>
  <div id="footer-upper" class="row-fluid footer-upper"> <div class="container"><?php print render($page['footer_upper']); ?></div> </div>
<?php endif; ?>
