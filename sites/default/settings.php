...
/* $databases = array (
  ...
  array (
    ...
    array (
      ...
      'username' => 'drupal',
      'password' => 'drupal',
      'host'     => 'mariadb', // Nombre del servicio DB en docker-compose
      'port'     => '3306',
      'driver'   => 'mysql',
      'prefix'   => '',
      // Evita problemas de caracteres en MySQL/MariaDB
      'charset'  => 'utf8mb4',
      'collation' => 'utf8mb4_general_ci',
    ),
  ),
...
$databases['default']['default'] = array(
  ...
  'password' => getenv('MYSQLPASSWORD') ?: 'FBeeHE3vUcBhtm2BfRZybhE_ZVvS9ONg',
  // Utiliza el Host Privado en la red de Railway, o el proxy público como fallback
  'host' => getenv('MYSQLHOST') ?: 'iriguchi.proxy.rlwy.net',
  'port' => getenv('MYSQLPORT') ?: 27711,
  'prefix' => '',
  'charset' => 'utf8',
  'collation' => 'utf8_general_ci',
);

$conf['drupal_use_utf8mb4'] = TRUE;
 ...
 *
 */
$drupal_hash_salt = 'hubr16Gyae23jo7MS4RUbs22d0uDFKBgmA2vO86uUDM';
...
/**
 * Ruta de Archivos Públicos y Temporales
 */
$conf['file_public_path'] = 'sites/default/files';
$conf['file_temporary_path'] = '/tmp';

/**
 * Desactivar la verificación rígida de URLs limpias si estás en desarrollo local
 */
$conf['clean_url'] = 1;

/**
 * Habilitar reporte de errores en desarrollo local (útil para detectar fallos en PHP 7.4)
 */
